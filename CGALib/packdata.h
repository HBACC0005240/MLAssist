		...
		namespace adaptor {
			...
			struct convert<cga_item_info_t> {
				msgpack::object const& operator()(msgpack::object const& o, cga_item_info_t& v) const {
					...
					v.assess_flags = o.via.array.ptr[9].as<short>();
					v.image_id = o.via.array.ptr[10].as<int>();
					return o;
				}
			};
			...
			struct object_with_zone<cga_item_info_t> {
				void operator()(msgpack::object::with_zone& o, cga_item_info_t const& v) const {
					...
					o.via.array.ptr[10] = msgpack::object(v.image_id, o.zone);
				}
			};
			...
			struct convert<cga_battle_unit_t> {
				msgpack::object const& operator()(msgpack::object const& o, cga_battle_unit_t& v) const {
					...
					v.petriding_modelid = o.via.array.ptr[9].as<int>();
					return o;
				}
			};
			...
			struct object_with_zone<cga_battle_unit_t> {
				void operator()(msgpack::object::with_zone& o, cga_battle_unit_t const& v) const {
					...
					o.via.array.ptr[9] = msgpack::object(v.petriding_modelid, o.zone);
				}
			};
			...
			struct convert<cga_map_cells_t> {
				msgpack::object const& operator()(msgpack::object const& o, cga_map_cells_t& v) const {
					...
					v.filename = o.via.array.ptr[5].as<std::string>();
					return o;
				}
			};
			...
			struct object_with_zone<cga_map_cells_t> {
				void operator()(msgpack::object::with_zone& o, cga_map_cells_t const& v) const {
					...
					o.via.array.ptr[5] = msgpack::object(v.filename, o.zone);
				}
			};
			...
			//tCard_Recv_Msg
			template<>
			struct convert<tCard_Recv_Msg> {
				msgpack::object const& operator()(msgpack::object const& o, tCard_Recv_Msg& v) const {
					if (o.type != msgpack::type::ARRAY) throw msgpack::type_error();
					if (o.via.array.size != 3) throw msgpack::type_error();
					v.state = o.via.array.ptr[0].as<int>();
			...
			template<>
			struct pack<tCard_Recv_Msg> {
				template <typename Stream>
				packer<Stream>& operator()(msgpack::packer<Stream>& o, tCard_Recv_Msg const& v) const {
					// packing member variables as an array.
					o.pack_array(3);
					o.pack(v.state);
					o.pack(v.date);
			...
			template <>
			struct object_with_zone<tCard_Recv_Msg> {
				void operator()(msgpack::object::with_zone& o, tCard_Recv_Msg const& v) const {
					o.type = type::ARRAY;
					o.via.array.size = 3;
					o.via.array.ptr = static_cast<msgpack::object*>(o.zone.allocate_align(sizeof(msgpack::object) * o.via.array.size));
					o.via.array.ptr[0] = msgpack::object(v.state, o.zone);
			...
			template<>
			struct convert<cga_card_recv_msg_t> {
				msgpack::object const& operator()(msgpack::object const& o, cga_card_recv_msg_t& v) const {
					if (o.type != msgpack::type::ARRAY) throw msgpack::type_error();
			...
			template<>
			struct pack<cga_card_recv_msg_t> {
				template <typename Stream>
				packer<Stream>& operator()(msgpack::packer<Stream>& o, cga_card_recv_msg_t const& v) const {
					// packing member variables as an array.
					o.pack_array(12);
					o.pack(v.index);
					o.pack(v.name);
			...
			template <>
			struct object_with_zone<cga_card_recv_msg_t> {
				void operator()(msgpack::object::with_zone& o, cga_card_recv_msg_t const& v) const {
					o.type = type::ARRAY;
					o.via.array.size = 12;
					o.via.array.ptr = static_cast<msgpack::object*>(o.zone.allocate_align(sizeof(msgpack::object) * o.via.array.size));
					o.via.array.ptr[0] = msgpack::object(v.index, o.zone);
