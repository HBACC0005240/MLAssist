...
{
    m_HeaderString.append(tr("条件"));
    m_HeaderString.append(tr("条件2"));
    m_HeaderString.append(tr("人物"));
    m_HeaderString.append(tr("人物目标"));
    m_HeaderString.append(tr("宠物"));
    m_HeaderString.append(tr("宠物目标"));
...
void CBattleSettingModel::clearAllSetting()
{
