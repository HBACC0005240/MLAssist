...
enum TObjectType
{
	...
	TObject_Pet,			 //宠物
	TObject_Item,			 //道具
	TObject_GateMap,		 //常用坐标
	TObject_Map,			 //地图信息
	TObject_AccountAssemble, //账号集合
	TObject_Account,		 //账号
	TObject_AccountGid,		 //账号子ID
	TObject_AccountRole,	 //账号子ID角色 左右角色
	TObject_GidRoleLeft,	 //账号子ID角色 左右角色
	TObject_GidRoleRight,	 //账号子ID角色 左右角色
	TObject_RoleRunConfig,	 //账号子ID角色 左右角色
};
enum TBattleType
{
	dtNone = 0,
...
enum TCmdID
{
	...
	cmdLogRequire = 0x0b,
	cmdGetUserPriv = 0x0c,
	cmdCheckTime = 0x0E,	  // 校对时间
	cmdChangePassword = 0x10, //更改登录口令
	cmdQueryAXFLog = 0x11,	  //日志查询
